...
This was a project I created for my MATH 335 Data Wrangling and Visualization class. As part of project requirements, I had to clean sales data from a variety of student-run companies and 
...
library(tidyverse)
library(lubridate)
# Update 10.29.20 - old package has depreciated, check to see if any changes need to be made to existing code
library(ggpubr)
```
